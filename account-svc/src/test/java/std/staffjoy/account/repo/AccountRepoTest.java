...
public class AccountRepoTest {
  ...
  public void setUp() {
    newAccount = Account.builder()
        ...
        .memberSince(
            LocalDateTime.of(2019, 1, 20, 12, 50).atZone(ZoneId.systemDefault()).toInstant())
        .confirmedAndActive(false)
        .photoUrl("https://staffjoy.std/photo/test.png")
  ...
  public void updateAccount() {
    ...
    toUpdateAccount.setEmail("update@staffjoy.std");
  ...
  public void updateEmailAndActivateById() {
    ...
    String toUpdateEmail = "update@staffjoy.std";
  ...
  public void updatePasswordById() {
    ...
    AccountSecret foundAccountSecret = accountSecretRepo
        .findAccountSecretByEmail(newAccount.getEmail());
