...
import std.staffjoy.account.TestConfig;
...
public class AccountControllerTest {
  ...
  public void testChangeEmail() {
    ...
    when(mailClient.send(any(EmailRequest.class))).thenReturn(
        BaseResponse.builder().message("email sent").build());
    ...
    EmailConfirmation emailConfirmation = EmailConfirmation.builder()
        ...
        .email(changedEmail)
        .build();
    BaseResponse baseResponse = accountClient
        .changeEmail(AuthConstant.AUTHORIZATION_WWW_SERVICE, emailConfirmation);
    ...
    GetOrCreateRequest getOrCreateRequest = GetOrCreateRequest.builder()
        .email(changedEmail)
        .build();
    genericAccountResponse = accountClient
        .getOrCreateAccount(AuthConstant.AUTHORIZATION_WWW_SERVICE, getOrCreateRequest);
    ...
    emailConfirmation = EmailConfirmation.builder()
        ...
        .email(changedEmail)
        .build();
    baseResponse = accountClient
        .changeEmail(AuthConstant.AUTHORIZATION_WWW_SERVICE, emailConfirmation);
    log.info(baseResponse.toString());
    assertThat(baseResponse.isSuccess()).isFalse();
    assertThat(baseResponse.getResultCode()).isEqualTo(ResultCode.NOT_FOUND);
  }
  ...
  public void testRequestEmailChange() {
    ...
    EmailChangeRequest emailChangeRequest = EmailChangeRequest.builder()
        ...
        .build();
    BaseResponse baseResponse = accountClient
        .requestEmailChange(AuthConstant.AUTHORIZATION_SUPPORT_USER, emailChangeRequest);
    assertThat(baseResponse.isSuccess()).isTrue();
    ...
    assertThat(StringUtils
        .countMatches(emailRequest.getHtmlBody(), "http://www." + externalApex + "/activate/"))
        .isEqualTo(3);
  ...
  public void testRequestPasswordReset() {
    ...
    PasswordResetRequest passwordResetRequest = PasswordResetRequest.builder()
        ...
        .build();
    BaseResponse baseResponse = accountClient
        .requestPasswordReset(AuthConstant.AUTHORIZATION_WWW_SERVICE, passwordResetRequest);
    assertThat(baseResponse.isSuccess()).isTrue();
    ...
    assertThat(emailRequest.getName()).isEqualTo(name);
    assertThat(StringUtils
        .countMatches(emailRequest.getHtmlBody(), "http://www." + externalApex + "/reset/"))
        .isEqualTo(2);
  ...
  public void testUpdateAndVerifyPasswordValidation() {
    ...
    UpdatePasswordRequest updatePasswordRequest = UpdatePasswordRequest.builder()
        ...
        .build();
    BaseResponse baseResponse = accountClient
        .updatePassword(AuthConstant.AUTHORIZATION_WWW_SERVICE, updatePasswordRequest);
    log.info(baseResponse.toString());
    assertThat(baseResponse.isSuccess()).isFalse();
    assertThat(baseResponse.getResultCode()).isEqualTo(ResultCode.PARAM_VALID_ERROR);
    ...
    VerifyPasswordRequest verifyPasswordRequest = VerifyPasswordRequest.builder()
        ...
        .build();
    genericAccountResponse = accountClient
        .verifyPassword(AuthConstant.AUTHORIZATION_WWW_SERVICE, verifyPasswordRequest);
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.NOT_FOUND);
    ...
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.REQ_REJECT);
    ...
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.UN_AUTHORIZED);
  }
  ...
  public void testUpdateAccountValidation() {
    ...
    when(mailClient.send(any(EmailRequest.class)))
        .thenReturn(BaseResponse.builder().message("email sent").build());
    when(botClient.sendSmsGreeting(any(GreetingRequest.class)))
    ...
    // no current user id
    GenericAccountResponse genericAccountResponse1 = accountClient
        .updateAccount(AuthConstant.AUTHORIZATION_AUTHENTICATED_USER, accountDto);
    log.info(genericAccountResponse1.toString());
    assertThat(genericAccountResponse1.isSuccess()).isFalse();
    assertThat(genericAccountResponse1.getResultCode()).isEqualTo(ResultCode.FAILURE);

    // set user id for testing
    TestConfig.TEST_USER_ID = accountDto.getId();
    genericAccountResponse1 = accountClient
        .updateAccount(AuthConstant.AUTHORIZATION_AUTHENTICATED_USER, accountDto);
    log.info(genericAccountResponse1.toString());
    ...
    log.info(genericAccountResponse1.toString());
    assertThat(genericAccountResponse1.isSuccess()).isFalse();
    assertThat(genericAccountResponse1.getResultCode()).isEqualTo(ResultCode.NOT_FOUND);
    ...
    log.info(genericAccountResponse1.toString());
    assertThat(genericAccountResponse1.isSuccess()).isFalse();
    assertThat(genericAccountResponse1.getResultCode()).isEqualTo(ResultCode.REQ_REJECT);
  ...
  public void testGetAccount() {
    ...
    // get account fail
    genericAccountResponse = accountClient
        .getAccount(AuthConstant.AUTHORIZATION_AUTHENTICATED_USER, accountDto.getId());
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.FAILURE);

    // get account success
    genericAccountResponse = accountClient
        .getAccount(AuthConstant.AUTHORIZATION_WHOAMI_SERVICE, accountDto.getId());
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isTrue();
  ...
  public void testListAccounts() {
    ...
    ListAccountResponse listAccountResponse = accountClient
  ...
  public void testCreateAccountValidation() {
    ...
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.PARAM_VALID_ERROR);
    ...
    createAccountRequest = CreateAccountRequest.builder()
        ...
        .build();
    genericAccountResponse = accountClient
        .createAccount(AuthConstant.AUTHORIZATION_ANONYMOUS_WEB, createAccountRequest);
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.UN_AUTHORIZED);
  }
  ...
  public void testGetAccountByPhoneNumber() {
    ...
    genericAccountResponse = accountClient
        .getAccountByPhonenumber(AuthConstant.AUTHORIZATION_SUPPORT_USER, phoneNumber);
    assertThat(genericAccountResponse.isSuccess()).isTrue();
    AccountDto accountDto = genericAccountResponse.getAccount();
    ...
    // invalid phone number
    genericAccountResponse = accountClient
        .getAccountByPhonenumber(AuthConstant.AUTHORIZATION_SUPPORT_USER, "invalid_phonenumber");
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.PARAM_VALID_ERROR);
    ...
    genericAccountResponse = accountClient
        .getAccountByPhonenumber(AuthConstant.AUTHORIZATION_SUPPORT_USER, "18001801299");
    log.info(genericAccountResponse.toString());
    assertThat(genericAccountResponse.isSuccess()).isFalse();
    assertThat(genericAccountResponse.getResultCode()).isEqualTo(ResultCode.NOT_FOUND);
  }
  ...
  public void testCreateAccountSuccess() {
    ...
    assertThat(StringUtils.countMatches(emailRequest.getHtmlBody(),
        "http://www." + envConfig.getExternalApex() + "/activate/")).isEqualTo(3);
    assertThat(StringUtils.countMatches(emailRequest.getHtmlBody(), name)).isEqualTo(1);
    assertThat(emailRequest.getHtmlBody()).startsWith("<div><p>Hi");
  }
