...
public class GlobalExceptionTranslator {
  ...
  public BaseResponse handleError(MissingServletRequestParameterException e) {
    ...
    return BaseResponse
        .builder()
        .resultCode(ResultCode.PARAM_MISS)
        .message(message)
        .build();
  }
  ...
  public BaseResponse handleError(BindException e) {
    ...
    return BaseResponse
        .builder()
        .resultCode(ResultCode.PARAM_BIND_ERROR)
        .message(message)
        .build();
  }
  ...
  public BaseResponse handleError(HttpMessageNotReadableException e) {
    ...
    return BaseResponse
        .builder()
        .resultCode(ResultCode.MSG_NOT_READABLE)
        .message(e.getMessage())
        .build();
  }
  ...
  public BaseResponse handleError(HttpRequestMethodNotSupportedException e) {
    ...
    return BaseResponse
        .builder()
        .resultCode(ResultCode.METHOD_NOT_SUPPORTED)
        .message(e.getMessage())
        .build();
  }
  ...
  public BaseResponse handleError(HttpMediaTypeNotSupportedException e) {
    ...
    return BaseResponse
        .builder()
        .resultCode(ResultCode.MEDIA_TYPE_NOT_SUPPORTED)
        .message(e.getMessage())
        .build();
  }
