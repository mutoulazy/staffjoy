...
public interface ShiftRepo extends JpaRepository<Shift, String> {
  ...
  List<Shift> listWorkerShifts(@Param("teamId") String teamId, @Param("userId") String userId,
      @Param("startTime") Instant start, @Param("endTime") Instant end);
  ...
  List<Shift> listShiftByUserId(@Param("teamId") String teamId, @Param("userId") String userId,
      @Param("startTime") Instant start, @Param("endTime") Instant end);
  ...
  List<Shift> listShiftByJobId(@Param("teamId") String teamId, @Param("jobId") String jobId,
      @Param("startTime") Instant start, @Param("endTime") Instant end);
  ...
  List<Shift> listShiftByUserIdAndJobId(@Param("teamId") String teamId,
      @Param("userId") String userId, @Param("jobId") String jobId,
      @Param("startTime") Instant start, @Param("endTime") Instant end);
