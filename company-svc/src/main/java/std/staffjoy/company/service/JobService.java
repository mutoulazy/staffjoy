...
public class JobService {
  ...
  public JobDto updateJob(JobDto jobDtoToUpdate) {
    // validate and will throw exception if not exist
    teamService
        .getTeamWithCompanyIdValidation(jobDtoToUpdate.getCompanyId(), jobDtoToUpdate.getTeamId());

    JobDto orig = this
        .getJob(jobDtoToUpdate.getId(), jobDtoToUpdate.getCompanyId(), jobDtoToUpdate.getTeamId());
