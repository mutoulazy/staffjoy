...
import std.staffjoy.company.TestConfig;
...
import std.staffjoy.company.repo.CompanyRepo;
import std.staffjoy.company.repo.JobRepo;
import std.staffjoy.company.repo.ShiftRepo;
import std.staffjoy.company.repo.TeamRepo;
import std.staffjoy.company.service.DirectoryService;
...
public class ShiftControllerTest {
  ...
  public void setUp() {
    ...
    // arrange mock
    when(accountClient.trackEvent(any(TrackEventRequest.class))).thenReturn(
    ...
    directoryEntryDto1 = DirectoryEntryDto.builder()
        ...
        .build();
    when(directoryService.getDirectoryEntry(company.getId(), userId1))
        .thenReturn(directoryEntryDto1);
    ...
    directoryEntryDto2 = DirectoryEntryDto.builder()
        ...
        .build();
    when(directoryService.getDirectoryEntry(company.getId(), userId2))
        .thenReturn(directoryEntryDto2);
  }
  ...
  public void testBulkPublishShifts() {
    ...
    GenericShiftListResponse shiftListResponse =
        companyClient
            .bulkPublishShifts(AuthConstant.AUTHORIZATION_SUPPORT_USER, bulkPublishShiftsRequest1);
    ...
    ArgumentCaptor<AlertRemovedShiftsRequest> argument1 = ArgumentCaptor
        .forClass(AlertRemovedShiftsRequest.class);
    ...
    shiftListResponse =
        companyClient
            .bulkPublishShifts(AuthConstant.AUTHORIZATION_SUPPORT_USER, bulkPublishShiftsRequest2);
    log.info(shiftListResponse.toString());
    assertThat(shiftListResponse.isSuccess()).isTrue();
    ...
    ArgumentCaptor<AlertNewShiftsRequest> argument2 = ArgumentCaptor
        .forClass(AlertNewShiftsRequest.class);
    ...
    assertThat(alertNewShiftsRequest.getNewShifts())
        .containsExactly(shiftDto1Clone, shiftDto2Clone);
  }
  ...
  public void deleteShift() {
    ...
    BaseResponse baseResponse =
        companyClient.deleteShift(AuthConstant.AUTHORIZATION_SUPPORT_USER, shiftDto1.getId(),
            shiftDto1.getTeamId(), shiftDto1.getCompanyId());
    assertThat(baseResponse.isSuccess()).isTrue();

    // capture and verify removed shift alert
    ArgumentCaptor<AlertRemovedShiftRequest> argument1 = ArgumentCaptor
        .forClass(AlertRemovedShiftRequest.class);
    ...
    GenericShiftResponse genericShiftResponse =
        companyClient
            .getShift(AuthConstant.AUTHORIZATION_SUPPORT_USER, shiftDto1.getId(), team.getId(),
                company.getId());
    assertThat(genericShiftResponse.isSuccess()).isFalse();
    assertThat(genericShiftResponse.getResultCode()).isEqualTo(ResultCode.NOT_FOUND);
    ...
    ShiftListRequest shiftListRequest1 = ShiftListRequest.builder()
        ...
        .shiftStartBefore(Instant.now().plus(5, ChronoUnit.DAYS))
        .build();
    GenericShiftListResponse shiftListResponse = companyClient
        .listShifts(AuthConstant.AUTHORIZATION_SUPPORT_USER, shiftListRequest1);
    log.info(shiftListResponse.toString());
    assertThat(shiftListResponse.isSuccess()).isTrue();
    ShiftList shiftList = shiftListResponse.getShiftList();
    // only shift2 left
  ...
  public void testUpdateShift() {
    ...
    ArgumentCaptor<AlertNewShiftRequest> argument2 = ArgumentCaptor
        .forClass(AlertNewShiftRequest.class);
    ...
    ArgumentCaptor<AlertChangedShiftRequest> argument3 = ArgumentCaptor
        .forClass(AlertChangedShiftRequest.class);
    // 3 times, 2 for create new shifts, 1 for republish
    ...
    // capture and verify new shift alert
    ArgumentCaptor<AlertNewShiftRequest> argument4 = ArgumentCaptor
        .forClass(AlertNewShiftRequest.class);
    ...
    // capture and verify removed shift alert
    ArgumentCaptor<AlertRemovedShiftRequest> argument5 = ArgumentCaptor
        .forClass(AlertRemovedShiftRequest.class);
  ...
  public void testListShifts() {
    ...
    shiftListResponse = companyClient
        .listShifts(AuthConstant.AUTHORIZATION_SUPPORT_USER, shiftListRequest2);
    log.info(shiftListResponse.toString());
    assertThat(shiftListResponse.isSuccess()).isTrue();
    shiftList = shiftListResponse.getShiftList();
    assertThat(shiftList.getShifts()).containsExactly(shiftDto1, shiftDto2);
    ...
    ShiftListRequest shiftListRequest3 = ShiftListRequest.builder()
        ...
        .build();
    shiftListResponse = companyClient
        .listShifts(AuthConstant.AUTHORIZATION_SUPPORT_USER, shiftListRequest3);
    log.info(shiftListResponse.toString());
    assertThat(shiftListResponse.isSuccess()).isTrue();
    shiftList = shiftListResponse.getShiftList();
    assertThat(shiftList.getShifts()).containsExactly(shiftDto1, shiftDto2);
    ...
    ShiftListRequest shiftListRequest4 = ShiftListRequest.builder()
        ...
        .build();
    shiftListResponse = companyClient
        .listShifts(AuthConstant.AUTHORIZATION_SUPPORT_USER, shiftListRequest4);
    log.info(shiftListResponse.toString());
    assertThat(shiftListResponse.isSuccess()).isTrue();
    shiftList = shiftListResponse.getShiftList();
    assertThat(shiftList.getShifts()).containsExactly(shiftDto1, shiftDto2);
  ...
  public void testListWorkerShifts() {
    ...
    GenericShiftListResponse genericShiftListResponse =
        companyClient
            .listWorkerShifts(AuthConstant.AUTHORIZATION_SUPPORT_USER, workerShiftListRequest);
    ...
    genericShiftResponse =
        companyClient
            .getShift(AuthConstant.AUTHORIZATION_SUPPORT_USER, shiftDto2.getId(), team.getId(),
                company.getId());
    assertThat(genericShiftResponse.isSuccess()).isTrue();
  ...
  public void createTwoShiftsAndVerify() {
    ...
    CreateShiftRequest createShiftRequest1 = CreateShiftRequest.builder()
        ...
        .build();
    GenericShiftResponse genericShiftResponse = companyClient
        .createShift(AuthConstant.AUTHORIZATION_SUPPORT_USER, createShiftRequest1);
    ...
    // capture and verify new shift alert
    ArgumentCaptor<AlertNewShiftRequest> argument = ArgumentCaptor
        .forClass(AlertNewShiftRequest.class);
    ...
    CreateShiftRequest createShiftRequest2 = CreateShiftRequest.builder()
        ...
        .build();
    genericShiftResponse = companyClient
        .createShift(AuthConstant.AUTHORIZATION_SUPPORT_USER, createShiftRequest2);
    log.info(genericShiftResponse.toString());
    assertThat(genericShiftResponse.isSuccess()).isTrue();
