...
import std.staffjoy.company.dto.worker.WorkerEntries;
...
public class WorkerControllerTest {
  ...
  public void testWorker() {
    ...
    GetWorkerOfResponse workerOfResponse = companyClient
        .getWorkerOf(AuthConstant.AUTHORIZATION_ACCOUNT_SERVICE, userId1);
    ...
    genericDirectoryResponse = companyClient
        .getWorker(AuthConstant.AUTHORIZATION_WWW_SERVICE, companyId, team.getId(), userId1);
    log.info(genericDirectoryResponse.toString());
    assertThat(genericDirectoryResponse.isSuccess()).isTrue();
    ...
    BaseResponse baseResponse = companyClient
        .deleteWorker(AuthConstant.AUTHORIZATION_SUPPORT_USER, workerDto1);
