...
public class JobControllerTest {
  ...
  public void testJob() {
    ...
    genericJobResponse = companyClient
        .updateJob(AuthConstant.AUTHORIZATION_SUPPORT_USER, jobDtoToUpdate);
    assertThat(genericJobResponse.isSuccess()).isTrue();
    ...
    // get job
    genericJobResponse =
        companyClient.getJob(AuthConstant.AUTHORIZATION_BOT_SERVICE, jobDto1.getId(), companyId,
            team.getId());
    log.info(genericJobResponse.toString());
    assertThat(genericJobResponse.isSuccess()).isTrue();
