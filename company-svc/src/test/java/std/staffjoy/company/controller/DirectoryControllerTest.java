...
import std.staffjoy.company.dto.directory.DirectoryList;
...
import std.staffjoy.company.repo.DirectoryRepo;
...
public class DirectoryControllerTest {
  ...
  public void testGetAndUpdateDirectory() {
    ...
    when(botClient.onboardWorker(any(OnboardWorkerRequest.class)))
        .thenReturn(BaseResponse.builder().message("worker onboard").build());
    ...
    NewDirectoryEntry newDirectoryEntry = NewDirectoryEntry.builder()
        ...
        .phoneNumber(phoneNumber)
        .build();
    GenericDirectoryResponse genericDirectoryResponse = companyClient
        .createDirectory(AuthConstant.AUTHORIZATION_WWW_SERVICE, newDirectoryEntry);
    ...
    when(accountClient.getAccount(AuthConstant.AUTHORIZATION_COMPANY_SERVICE, accountDto.getId()))
        .thenReturn(genericAccountResponse);
    genericDirectoryResponse = companyClient
        .getDirectoryEntry(AuthConstant.AUTHORIZATION_WWW_SERVICE, companyId, accountDto.getId());
    log.info(genericDirectoryResponse.toString());
    assertThat(genericDirectoryResponse.isSuccess()).isTrue();
    ...
    genericDirectoryResponse = companyClient
        .updateDirectoryEntry(AuthConstant.AUTHORIZATION_SUPPORT_USER, directoryEntryDto2);
    log.info(genericDirectoryResponse.toString());
    assertThat(genericDirectoryResponse.isSuccess()).isTrue();
    ...
    assertThat(genericDirectoryResponse.getResultCode()).isEqualTo(ResultCode.PARAM_VALID_ERROR);
    ...
    log.info(genericDirectoryResponse.toString());
    assertThat(genericDirectoryResponse.isSuccess()).isFalse();
    assertThat(genericDirectoryResponse.getResultCode()).isEqualTo(ResultCode.UN_AUTHORIZED);
    ...
    ArgumentCaptor<OnboardWorkerRequest> argument = ArgumentCaptor
        .forClass(OnboardWorkerRequest.class);
  ...
  public void testGetDirectory() {
    ...
    // not found test
    GenericDirectoryResponse genericDirectoryResponse = companyClient
        .getDirectoryEntry(AuthConstant.AUTHORIZATION_WWW_SERVICE, companyId, userId);
    log.info(genericDirectoryResponse.toString());
    assertThat(genericDirectoryResponse.isSuccess()).isFalse();
    assertThat(genericDirectoryResponse.getResultCode()).isEqualTo(ResultCode.NOT_FOUND);
  ...
  public void testListDirectory() {
    ...
    // empty test
    ListDirectoryResponse listDirectoryResponse = companyClient
        .listDirectories(AuthConstant.AUTHORIZATION_SUPPORT_USER, companyId, 0, 2);
    ...
    // verify list
    listDirectoryResponse = companyClient
        .listDirectories(AuthConstant.AUTHORIZATION_SUPPORT_USER, companyId, 0, 2);
    log.info(listDirectoryResponse.toString());
    assertThat(listDirectoryResponse.isSuccess()).isTrue();
    ...
    // verify second page
    listDirectoryResponse = companyClient
        .listDirectories(AuthConstant.AUTHORIZATION_SUPPORT_USER, companyId, 1, 2);
    log.info(listDirectoryResponse.toString());
    assertThat(listDirectoryResponse.isSuccess()).isTrue();
    directoryList = listDirectoryResponse.getDirectoryList();
  ...
  public void testCreateDirectoryFailure() {
    ...
    log.info(genericDirectoryResponse.toString());
    assertThat(genericDirectoryResponse.isSuccess()).isFalse();
    assertThat(genericDirectoryResponse.getResultCode()).isEqualTo(ResultCode.FAILURE);

    GenericAccountResponse genericAccountResponse = new GenericAccountResponse();
    genericAccountResponse.setResultCode(ResultCode.FAILURE);
  ...
  public void testCreateDirectory() {
    ...
    // capture and verify worker onboard request
    ArgumentCaptor<OnboardWorkerRequest> argument2 = ArgumentCaptor
        .forClass(OnboardWorkerRequest.class);
