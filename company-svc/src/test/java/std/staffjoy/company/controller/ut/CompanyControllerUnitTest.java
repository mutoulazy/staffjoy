package std.staffjoy.company.controller.ut;
...
public class CompanyControllerUnitTest {
  ...
  public void testCreateCompanyAuthorizeMissing() throws Exception {
    ...
    GenericCompanyResponse genericCompanyResponse = objectMapper
        .readValue(mvcResult.getResponse().getContentAsString(), GenericCompanyResponse.class);
    assertThat(genericCompanyResponse.isSuccess()).isFalse();
    assertThat(genericCompanyResponse.getResultCode()).isEqualTo(ResultCode.UN_AUTHORIZED);
  }
  ...
  public void testCreateCompanyInvalidDayWeekStarts() throws Exception {
    ...
    GenericCompanyResponse genericCompanyResponse = objectMapper
        .readValue(mvcResult.getResponse().getContentAsString(), GenericCompanyResponse.class);
    assertThat(genericCompanyResponse.isSuccess()).isFalse();
    assertThat(genericCompanyResponse.getResultCode()).isEqualTo(ResultCode.PARAM_VALID_ERROR);
    assertThat(genericCompanyResponse.getMessage()).startsWith("defaultDayWeekStarts")
        .endsWith("Unknown day of week");
  }
  ...
  public void testCreateCompanyInvalidTimezone() throws Exception {
    ...
    assertThat(genericCompanyResponse.isSuccess()).isFalse();
    assertThat(genericCompanyResponse.getResultCode()).isEqualTo(ResultCode.PARAM_VALID_ERROR);
    assertThat(genericCompanyResponse.getMessage()).startsWith("defaultTimezone")
        .endsWith("Invalid timezone");
  }
  ...
  public void testCreateCompanyEmptyName() throws Exception {
    ...
    assertThat(genericCompanyResponse.isSuccess()).isFalse();
    assertThat(genericCompanyResponse.getResultCode()).isEqualTo(ResultCode.PARAM_VALID_ERROR);
    assertThat(genericCompanyResponse.getMessage()).startsWith("name")
        .endsWith("must not be blank");
  }
  ...
  public void testListCompanySuccessfully() throws Exception {
    ...
    ListCompanyResponse listCompanyResponse = objectMapper
        .readValue(mvcResult.getResponse().getContentAsString(), ListCompanyResponse.class);
  ...
  public void testListCompanyMissingParam() throws Exception {
    ...
    assertThat(listCompanyResponse.getResultCode()).isEqualTo(ResultCode.PARAM_MISS);
    assertThat(listCompanyResponse.getMessage()).startsWith("Missing Request Parameter:")
        .endsWith("offset");
  }
  ...
  public void testGetCompanyMissingPathVariable() throws Exception {
    ...
    GenericCompanyResponse genericCompanyResponse = objectMapper
        .readValue(mvcResult.getResponse().getContentAsString(), GenericCompanyResponse.class);
    assertThat(genericCompanyResponse.isSuccess()).isFalse();
    assertThat(genericCompanyResponse.getResultCode()).isEqualTo(ResultCode.PARAM_MISS);
    assertThat(genericCompanyResponse.getMessage()).startsWith("Missing Request Parameter:")
        .endsWith("company_id");
  }
