...
public class DirectoryRepoTest {
  ...
  public void testDirectory() {
    ...
    int result = directoryRepo
        .updateInternalIdByCompanyIdAndUserId(directory1.getInternalId(), "C100001", "U100001");
    assertTrue(result == 1);
    foundDirectory = directoryRepo.findByCompanyIdAndUserId("C100001", "U100001");
    assertThat(foundDirectory).isNotNull();
    assertThat(foundDirectory).isEqualTo(directory1);

    result = directoryRepo
        .updateInternalIdByCompanyIdAndUserId(directory1.getInternalId(), "C100003", "U100001");
    assertTrue(result == 0);
  }
